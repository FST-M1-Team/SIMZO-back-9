...
LANGUAGE_CODE = 'fr-fr'
TIME_ZONE = 'UTC'  # UTC en base, Django convertira pour l'affichage
USE_I18N = True
USE_TZ = True
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Où collectstatic rassemble tout

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Où les images de vos utilisateurs arrivent
...
META_API_KEY = env('META_API_KEY', default=None)
